...
class ColorInterface {
    ...
    choose_color_sp(district, party, candidates, metric, polarity) {
        ...
        return cand_to_color[party][max_c];
    }
    ...
    choose_color_cp(district, democrats, republicans, metric, polarity) {
        if (metric == 'avg_sentiment') {
            ...
            if (dem_value === null && rep_value === null) {
                ...
                return drColorScale(0);
            }
            else if (rep_value === null) {
                return drColorScale(1);
            }
            return drColorScale(dem_value / (dem_value + rep_value));
        }
        ...
        return drColorScale(dem_total / (dem_total + rep_total)); // more blue, the higher dems are, and vice versa
    }

    chose_color(district, democrats, republicans, metric, polarity) {
